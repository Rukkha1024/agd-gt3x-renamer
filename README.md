...
MOS2D36155148_김선옥 (2025-11-13)60sec.agd
```
...
2. 관리번호 조회 (관리번호-시리얼번호.xlsx)
   ...
   ↓
3. 이름 조회 (대상자 키,체중,주손 정보.xlsx)
   관리번호: 105 + 구분: 40주차 → 이름: 김선옥
   ↓
4. 새 파일명 생성
   MOS2D36155148_김선옥 (2025-11-13).gt3x
```
...
✅ [DRY-RUN] MOS2D36155148 (2025-11-13).gt3x -> MOS2D36155148_김선옥 (2025-11-13).gt3x
⏭️  MOS2D36155148_김선옥 (2025-11-13)60sec.agd: 이미 변경됨
